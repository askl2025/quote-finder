...
def register_chinese_font():
    ...
    # 如果找不到系统字体，尝试使用打包后的字体
    if hasattr(sys, '_MEIPASS'):
        bundled_font = os.path.join(sys._MEIPASS, 'fonts', 'msyh.ttc')
        if os.path.exists(bundled_font):
            try:
                LabelBase.register(name='Chinese', fn_regular=bundled_font)
                return 'Chinese'
            except:
                pass
...
if CHINESE_FONT:
    ...
    CoreLabel.font_name = CHINESE_FONT
